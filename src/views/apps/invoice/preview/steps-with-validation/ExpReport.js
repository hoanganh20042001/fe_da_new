    ...
    <Fragment>
      ...
      {report && (
        <div>
          ...
          <p>Mô hình được sử dụng: {report.configexpid__expmodelid}</p>
          <p>Testing Dataset Name: {report.testing_result.resulttestingdataset__datasetname}</p> */}
          {/* <p>Testing Dataset Accuracy: {report.testing_result.resultaccuracy}</p> */}
