...
const Predict = ({ stepper, infoExp }) => {
        ...
        , {
          ...
          , {
            ...
            , {
              ...
              setUrl(path)
              if (response.data.data.data.accuracy !== null) {
                setDetail(response.data.data.data.accuracy)
              } else {
                setDetail('Không có kết quả trả về')
  ...
  const DowLoadReport = () => {
    const url = process.env.REACT_APP_API_URL
    axios({
      url: `${url}/download-report/?configID=${dataExp.configid}`,
      method: 'GET',
      ...
      <Card>
        ...
        <CardBody>
            ...
            <Col md={12} xs={12}>
              ...
              <Input type='file' id='salary' onChange={(e) => setFiles1(e.target.files[0])} accept=".png, .jpg, .jpeg"/>
            </Col>
                <Row>
          ...
          <div className='d-flex justify-content-between' style={{ marginTop: '20px' }}>
            ...
            <Button type='button' color='primary' className='btn-next' onClick={() => DowLoadReport()} disabled={files === undefined || files1 === undefined}>
