...
const FileUploaderSingle = ({ stepper, infoExp }) => {
  // ** State
          ...
          {files.length ? (
            <Fragment>
              ...
              <div className='d-flex justify-content-end'>
                ...
                <Button color='primary'>Tải thư mục</Button>
              </div>
            </Fragment>
          ) : null}
        </CardBody>
          ...
          {files.length ? (
            <Fragment>
              ...
              <div className='d-flex justify-content-end'>
                ...
                <Button color='primary'>Xoá tất cả</Button>
              </div>
            </Fragment>
          ) : null}
        </CardBody>
