    ...
    axios.post(`${url}/register/`, {
      ...
      .then(res => {
        MySwal.fire({
          icon: 'success',
          title: 'Thành công',
          text: 'Bạn đã đăng kí thành công vui lòng chờ kĩ thuật viên phê duyệt',
          customClass: {
            ...
            <Form action='/' className='auth-register-form mt-2' onSubmit={handleSubmit(onSubmit)}>
              <div className='mb-1'>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input autoFocus invalid={errors.username && true} {...field} />
                  )}
                />
              ...
              <div className='mb-1'>
                ...
                <Controller
                  ...
                  name='email'
                  control={control}
                  rules={{ required: 'Tên email là bắt buộc.' }}
                  render={({ field }) => (
              ...
              <div className='mb-1'>
                ...
                <Controller
                  ...
                  name='password'
                  control={control}
                  rules={{ required: 'Mât khẩu người dùng là bắt buộc.' }}
                  render={({ field }) => (
